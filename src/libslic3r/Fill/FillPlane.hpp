#ifndef slic3r_FillPlane_hpp_
#define slic3r_FillPlane_hpp_
...
class FillPlane : public Fill
{

public:
    Fill* clone() const override { return new FillPlane(*this); };
    ~FillPlane() override = default;
